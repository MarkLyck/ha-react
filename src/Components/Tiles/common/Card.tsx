...
export const ActionableCardContainer = styled(CardContainer)<WithActiveProps>`
  background-color: ${(props) =>
    props.isActive
      ? props.theme.card.background.colorActive
      : props.theme.card.background.colorInactive};
  opacity: ${(props) =>
    props.isActive ? '100%' : props.isActive === false ? '70%' : '100%'};
  cursor: pointer;
  &:active {
    transform: scale(0.9);
  }
...
export const CardName = styled.div<WithActiveProps>`
  ...
  color: ${(props) =>
    props.isActive
      ? props.theme.card.name.colorActive
      : props.theme.card.name.colorInactive};
`
...
export const CardState = styled.div<WithActiveProps>`
  ...
  color: ${(props) =>
    props.isActive
      ? props.theme.card.state.colorActive
      : props.theme.card.state.colorInactive};
`
